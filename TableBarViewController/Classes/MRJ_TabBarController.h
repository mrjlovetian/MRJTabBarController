...
@property (nonatomic, copy) NSString *mrj_tabItemTitle; // tabItem的标题
@property (nonatomic, strong) UIImage *mrj_tabItemImage; // tabItem的图像
@property (nonatomic, strong) UIImage *mrj_tabItemSelectedImage; // tabItem的选中图像
